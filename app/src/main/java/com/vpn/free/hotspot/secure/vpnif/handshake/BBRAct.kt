...
import com.vpn.free.hotspot.secure.vpnif.handshake.Constants.C2
import com.vpn.free.hotspot.secure.vpnif.handshake.Constants.C3
import com.vpn.free.hotspot.secure.vpnif.handshake.Constants.DL1
import com.vpn.free.hotspot.secure.vpnif.handshake.Constants.DL2
import com.vpn.free.hotspot.secure.vpnif.handshake.Constants.DL3
import java.io.File
...
class BBRAct : AppCompatActivity() {
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.vpn.free.hotspot.secure.vpnif"
        ...
        val first = "https://"
        val second = "wolfspire.site/6TgT2"
...
//        val after = "$resultAB?$one$cpOne&$two$cpTwo&$three$cpThree&$four$dpOne&$five$dpTwo&$six$dpThree&$seven$pack&$eight$afId&$nine$mainid&$ten$androidVersion"
        ...
        if (cpOne != null) {
            after =
                "$resultAB?$one$cpOne&$two$cpTwo&$three$cpThree&$four$pack&$five$afId&$six$mainid&$seven$androidVersion&$eight" + "namings"
        } else {
            after =
                "$resultAB?$one$dpOne&$two$dpTwo&$three$dpThree&$four$pack&$five$afId&$six$mainid&$seven$androidVersion&$eight" + "deeplinks"
        }
